package com.cyngofokglobal.patientservice.controller;
...
import com.cyngofokglobal.patientservice.service.PatientService;
...
public class PatientController {
    ...
    @PostMapping
    public ResponseEntity<PatientResponseDTO> crestPatient(
